  ...
  return (
    ...
    >
      ...
      <body className="min-h-full flex flex-col font-sans">
        {/* Easter egg for anyone reading view-source: the actual 8-bit ASTRA
            wordmark, invisible on the page but sitting in the source and
            inline-previewable from devtools. next/image would proxy this
            through the optimiser for no benefit: it's already a tiny inline
            data URI, not a network request. */}
