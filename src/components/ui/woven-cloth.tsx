...
// The authored source renders the studio's own wordmark into the cloth. Swap it
// for ASTRA's, keeping the same replacement mechanism.
function wovenClothLabelSource(source: string) {
  return [
    ["x.fillText('L W', W/2, 190);", "x.fillText('A B', W/2, 190);"],
    [
      "x.fillText('· KYOTO ·', W/2, 246);",
      "x.fillText('· MILANO ·', W/2, 246);",
    ],
    ["x.fillText('LUMINA', W/2, 400);", "x.fillText('ASTRA', W/2, 400);"],
    ["x.fillText('WEAVERS', W/2, 520);", "x.fillText('BOCCONI', W/2, 520);"],
    [
      "x.fillText('K I N E T I C   T E X T I L E S   ·   2 0 2 4', W/2, 626);",
      "x.fillText('R E T E   S T U D E N T E S C A', W/2, 626);",
    ],
  ].reduce(
